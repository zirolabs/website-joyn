...
class Regis_upload extends MX_Controller {
    ...
    function __construct(){
        ...
        // $this->driver_path = base_url() . '/upload/berkas_driver/';
        // $this->mart_food_path = base_url() . '/upload/berkas_mmart_mfood/';
        // $this->massage_path = base_url() . '/upload/berkas_mmassage/';
        // $this->service_path = base_url() . '/upload/berkas_mservice/';
    }

    ...
    public function upload(){
        ...
        if($_FILES['foto_diri']['name'] != ''){
            ...
            elseif($_FILES["foto_diri"]["size"] > 1000000){
                $pesan = $pesan.'-Photos Profile are too big\\n';
                $validasi = 1;
            }
            ...
            // }
                ...
                // if($insert_kendaraan){
                    ...
                    // if($insert_lamaran){
                        ...
                        $pathfilesavektp = $_SERVER['DOCUMENT_ROOT'] . "/upload/berkas_driver/foto_ktp/";
                        $pathfilesavestnk = $_SERVER['DOCUMENT_ROOT'] . "/upload/berkas_driver/foto_stnk/";
                        $pathfilesavesim = $_SERVER['DOCUMENT_ROOT'] . "/upload/berkas_driver/foto_sim/";
                        $pathfilesaveprofil = $_SERVER['DOCUMENT_ROOT'] . "/upload/berkas_driver/foto_diri/";
    ...
    elseif($validasi == 0){
        ...
        if($insert_lamaran){
            ...
            if($insert_foto){
                ...
                $pathfilesavektp = $_SERVER['DOCUMENT_ROOT'] . "/upload/berkas_mmassage/foto_ktp/";
                $pathfilesaveprofil = $_SERVER['DOCUMENT_ROOT'] . "/upload/berkas_mmassage/foto_diri/";
...
elseif($validasi == 0){
    ...
    if($insert_lamaran){
        ...
        if($insert_foto){
            $pathfilesavektp = $_SERVER['DOCUMENT_ROOT'] . "/upload/berkas_mservice/foto_ktp/";
            $pathfilesaveprofil = $_SERVER['DOCUMENT_ROOT'] . "/upload/berkas_mservice/foto_diri/";
            $config['upload_path']          = $pathfilesavektp;
            $config['allowed_types']        = 'gif|jpg|jpeg|png|GIF|JPG|JPEG|PNG';
            $config['file_name']            = 'ktp_'.$data_berkas[0]['nomor'];
            $this->load->library('upload', $config);
...
elseif($validasi == 0){
    ...
    if($insert_restoran){
        ...
        if($insert_nama_foto){
            $pathfilesaveresto = $_SERVER['DOCUMENT_ROOT'] . "/upload/berkas_mmart_mfood/foto_restoran/";
